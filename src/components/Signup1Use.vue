<template>
<pre class="signup1-use">
핸디즈는 회원님들의 권익을 보호하고, 회원님들의 개인정보 보호에 만전을 기하고자, 관계법령 규정을 반영하여 약관을 변경하였습니다.

제1장 총 칙

제 1 조 (목적)
본 약관은 서비스 이용자가 주식회사 핸디즈(이하 "회사” 또는 “핸디즈"이라 합니다)가 제공하는 온라인상의 인터넷 서비스인 핸디즈(이하 “서비스”라고 하며, 접속 가능한 유∙무선 단말기의 종류와는 상관없이 이용 가능한 “회사”가 제공하는 모든 “서비스”를 의미합니다. 이하 같습니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 회원(본 약관에 동의하고 회원등록을 완료한 서비스 이용자를 말합니다. 이하 “회원”이라고 합니다)의 권리•의무 및 책임사항을 규정함을 목적으로 합니다. 
...
제 8 조 (서비스 이용)
① 서비스 이용은 회사의 서비스 사용승낙 직후부터 가능합니다. 다만, 법인 고객의 경우 유료 서비스는 회사가 요금납입을 확인한 직후부터 가능하게 할 수 있습니다.
...
제 9 조 (서비스내용변경 통지 등)
① 회사가 서비스 제공을 위해 계약한 CP(Contents Provider)와의 계약종료, CP의 변경, 신규서비스의 개시 등의 사유로 서비스 내용이 변경되거나 서비스가 종료되는 경우 회사는 회원의 등록된 전자우편 주소 혹은 전화번호를 이용하여 이메일이나 문자서비스를 통하여 서비스 내용의 변경 사항 또는 종료를 통지할 수 있습니다.
...
④ 회원이 서비스를 이용하는 도중, 연속하여 십이(12)개월 동안 서비스를 이용하기 위해 log-in한 기록이 없는 경우, 회사는 당해 회원 “핸디즈 서비스"의 이용을 제한할 수 있습니다. 
...
② 회사가 제공하는 유료서비스에 대한 이용요금의 결제 방법은 신용카드결제, 계좌이체, 무통장입금 등이 있으며 회사의 서비스 상황에 따라 결제 방법의 차이가 있을 수 있습니다.
...
회사가 제공하는 유료서비스가 특정한 행위 시 차감되는 서비스일 경우 해지일로부터 차감된 금액과 남은 금액의 10%를 제외한 금액을 환불합니다. 단, 유료 서비스 이용 개시일로 7일 이내에 해지를 요구하는 경우 이용 금액만 제외하고 환불합니다. 청소서비스에 관한 금액을 환불할 경우 1회만 서비스를 이용하고, 환불을 요청하는 경우 위 항의 제외를 포함하고도 9,900원의 수수료를 차감하고 환불합니다.
...
⑦ 본 조의 규정에 의한 환불은 환불 의무가 발생한 날로부터 7영업일 이내에 하는 것으로 하며 환불에 회원의 협조가 필요한 경우 7영업일을 초과할 수 있습니다.
...
⑥ 본 이용 계약이 해지된 경우 회원의 “게시물 등” 의 회원 식별이 가능한 정보는 일체는 삭제됩니다.
